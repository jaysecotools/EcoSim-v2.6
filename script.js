// Tasmanian Ecosystem Simulator - Modern Version
// Global Variables
...
const ecosystemHealthDisplay = document.getElementById('ecosystemHealth');
const grassValue = document.getElementById('grass-value');
const pademelonsValue = document.getElementById('pademelons-value');
const devilsValue = document.getElementById('devils-value');
const bandicootsValue = document.getElementById('bandicoots-value');
